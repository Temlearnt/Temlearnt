...
location: Indonesia
focus: RESTful APIs, Database Architecture, Server-Side Systems & Cloud Services
```

- 🔭 **Currently Working On:** Building RESTful backend APIs, database schemas, and backend micro-services
- 🌱 **Currently Exploring:** Go concurrency, Advanced SQL & Indexing, Docker, and REST API best practices
- 💬 **Ask Me About:** Python, FastAPI, Node.js, PostgreSQL, MySQL, and RESTful API Design
- ⚡ **Fun Fact:** I find real satisfaction in clean database schemas and sub-100ms API response times.
...
| :--- | :--- |
| **Frontend** | `TypeScript` |
| **Backend & APIs** | `Node.js` • `Express.js` • `Go (Golang)` • `Python` • `PHP` • `FastAPI` |
| **Databases & Cache** | `PostgreSQL` • `MongoDB` • `Redis` • `MySQL` |
| **Cloud & DevOps** | `Docker` • `Linux` |
| **Tools & Environment** | `Git` • `Postman` |
